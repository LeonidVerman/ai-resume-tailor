...
PHASE1_TEMPERATURE: float = float(os.environ.get("PHASE1_TEMPERATURE", "0.3"))
PHASE1_REPAIR_TEMPERATURE: float = float(os.environ.get("PHASE1_REPAIR_TEMPERATURE", "0.3"))
PHASE2_TEMPERATURE: float = float(os.environ.get("PHASE2_TEMPERATURE", "0.3"))
PHASE2_REPAIR_TEMPERATURE: float = float(os.environ.get("PHASE2_REPAIR_TEMPERATURE", "0.1"))
